...
# ===== ACT 8b diagnose YOUR batch (inserted; extends to ~12 min) =====
th("Now let me make this personal, because I want you to be able to look at your own failed candle and know exactly what went wrong.")
th("So pick up a candle that disappointed you, and let us actually read it together, like a little detective story. Your candle is telling you everything.")
th("If you see cloudy patches where the wax pulled off the glass, that is the wet-spot signature. Your jar was too cold when the hot wax hit it.")
br("A failed candle being turned slowly under the light to read its defects.","slowly turns a flawed candle under the light, pointing at each defect in turn as if reading it")
th("If you see a crater sunk down around the wick, that is a sinkhole, and it means you poured too hot and cooled too fast, so the middle collapsed.")
th("If the top looks white and crusty, like cottage cheese, that is frosting and thermal shock. Hot wax met a cold room and the surface panicked.")
th("And if it burns but barely smells, your fragrance most likely flashed off because you added it while the wax was still way too hot.")
th("Do you see the pattern? Every single one of those clues points back to the same place. Temperature. The candle is practically confessing.")
th("So here is what I want you to do. Get a cheap notebook, and from your very next batch, write down four numbers every single time.")
br("A simple notebook open on the bench with a thermometer resting beside it.","sets an open notebook on the bench beside a thermometer, smoothing the page flat with one hand")
th("Write the melt temperature, the temperature you added fragrance, the temperature you poured at, and the room temperature that day.")
th("Just four numbers, thirty seconds of writing. And within three or four batches, you will see your own personal recipe appear on the page.")
th("Because here is the truth. The makers who never fail are not more talented than you. They just stopped guessing and started writing it down.")
th("Your candles do not need you to be perfect. They just need you to be consistent, and a notebook is how consistency actually happens.")
th("Once you have your numbers locked in, candle making stops feeling like gambling, and it starts feeling like following a recipe that always works.")
# ===== ACT 9 verdict + CTA =====
