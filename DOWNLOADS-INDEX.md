...
## ⭐ FINAL 5 DELIVERABLES v2 (no-cutoff, face-clean, chapters) — zips
Truncation fixed (over-long sentences split so every clip says its full line; verified by transcription), face-gate clean (2-class ArcFace), smooth same-scene crossfades, no seam stutter. Each zip = final video + all source clips + thumbnail + description.txt (🔗 book CTA + link → description → chapters → hashtags). Book link in every description: https://candicescandles.com
| # | Video | Zip |
|---|---|---|
...
- "100 Defective Candles" — all source clips (~181 MB): https://litter.catbox.moe/o8p7oc.zip
- Video 3 (Veo + Grok) clip zips: added when those finish generating.
...
## Video 8 v2 — Microwave Wax Hack (talking-head-dominant ~83%, gap-TTS, 100% Veo, 11:48, full-sentence fix)
- Video (fixed, full sentences): https://litter.catbox.moe/q6529j.mp4
